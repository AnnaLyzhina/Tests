...
Готовое решение всех 3 задач из раздела `4.Tests`.
...
> Это дополнительная задача из домашней работы. Тест запускается только если заданы логин и пароль в переменных окружения.
...
- Для задания №2 и №3 нужны реальные данные доступа.
- Если переменные окружения не заданы, Selenium-тест будет пропущен автоматически.